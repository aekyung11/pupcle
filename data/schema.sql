...
--
-- Name: tg_notification_on_friend_request(); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.tg_notification_on_friend_request() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: FUNCTION tg_notification_on_friend_request(); Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON FUNCTION app_public.tg_notification_on_friend_request() IS 'Send notification on new friend request';


--
-- Name: tg_notification_on_mission_invite(); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.tg_notification_on_mission_invite() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: FUNCTION tg_notification_on_mission_invite(); Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON FUNCTION app_public.tg_notification_on_mission_invite() IS 'Send notification on mission invite';
...
--
-- Name: tg_pupcles_on_complete_mission(); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.tg_pupcles_on_complete_mission() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: FUNCTION tg_pupcles_on_complete_mission(); Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON FUNCTION app_public.tg_pupcles_on_complete_mission() IS 'Gives reward pupcles to the user when the user completes a mission';


--
-- Name: tg_update_count_on_participant_mission(); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.tg_update_count_on_participant_mission() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: FUNCTION tg_update_count_on_participant_mission(); Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON FUNCTION app_public.tg_update_count_on_participant_mission() IS 'Update participant count when a user participates in a mission';
...
--
-- Name: mission_invites; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: mission_participants; Type: TABLE; Schema: app_public; Owner: -
--

CREATE TABLE app_public.mission_participants (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    mission_id uuid NOT NULL,
    user_id uuid NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT mission_participants_proof_image_url_check CHECK ((proof_image_url ~ '^https?://[^/]+'::text))
);


--
-- Name: mission_period_kind; Type: TABLE; Schema: app_public; Owner: -
--
...
--
-- Name: TABLE mission_period_kind; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.mission_period_kind IS '@enum';


--
-- Name: missions; Type: TABLE; Schema: app_public; Owner: -
--
...
CREATE TABLE app_public.notifications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT notifications_action_url_check CHECK ((action_url ~ '^https?://[^/]+'::text))
);
...
--
-- Name: mission_invites mission_invites_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_invites
    ADD CONSTRAINT mission_invites_pkey PRIMARY KEY (from_user_id, to_user_id, mission_id);


--
-- Name: mission_participants mission_participants_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_participants
    ADD CONSTRAINT mission_participants_pkey PRIMARY KEY (id);


--
-- Name: mission_participants mission_participants_user_id_mission_id_key; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_participants
    ADD CONSTRAINT mission_participants_user_id_mission_id_key UNIQUE (user_id, mission_id);


--
-- Name: mission_period_kind mission_period_kind_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_period_kind
    ADD CONSTRAINT mission_period_kind_pkey PRIMARY KEY (period);


--
-- Name: missions missions_name_period_day_key; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.missions
    ADD CONSTRAINT missions_name_period_day_key UNIQUE (name, period, day);


--
-- Name: missions missions_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--
...
--
-- Name: mission_invites_created_at_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX mission_invites_created_at_idx ON app_public.mission_invites USING btree (created_at);


--
-- Name: mission_invites_mission_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX mission_invites_mission_id_idx ON app_public.mission_invites USING btree (mission_id);


--
-- Name: mission_invites_to_user_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX mission_invites_to_user_id_idx ON app_public.mission_invites USING btree (to_user_id);


--
-- Name: mission_participants_mission_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX mission_participants_mission_id_idx ON app_public.mission_participants USING btree (mission_id);


--
-- Name: missions_day_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX missions_day_idx ON app_public.missions USING btree (day);


--
-- Name: missions_name_period_day_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX missions_name_period_day_idx ON app_public.missions USING btree (name, period, day);


--
-- Name: missions_period_day_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX missions_period_day_idx ON app_public.missions USING btree (period, day);


--
-- Name: notifications_created_at_user_id_read_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX notifications_created_at_user_id_read_idx ON app_public.notifications USING btree (created_at, user_id, read);


--
-- Name: notifications_user_id_read_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX notifications_user_id_read_idx ON app_public.notifications USING btree (user_id, read);
...
--
-- Name: poi_reviews_comment_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX poi_reviews_comment_idx ON app_public.poi_reviews USING btree (comment);


--
-- Name: poi_reviews_created_at_comment_poi_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX poi_reviews_created_at_comment_poi_id_idx ON app_public.poi_reviews USING btree (created_at, comment, poi_id);
...
--
-- Name: poi_reviews_rating_comment_poi_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX poi_reviews_rating_comment_poi_id_idx ON app_public.poi_reviews USING btree (rating, comment, poi_id);
...
--
-- Name: mission_invites _100_timestamps; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_timestamps BEFORE INSERT OR UPDATE ON app_public.mission_invites FOR EACH ROW EXECUTE FUNCTION app_private.tg__timestamps();


--
-- Name: mission_participants _100_timestamps; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_timestamps BEFORE INSERT OR UPDATE ON app_public.mission_participants FOR EACH ROW EXECUTE FUNCTION app_private.tg__timestamps();


--
-- Name: missions _100_timestamps; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_timestamps BEFORE INSERT OR UPDATE ON app_public.missions FOR EACH ROW EXECUTE FUNCTION app_private.tg__timestamps();


--
-- Name: notifications _100_timestamps; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _100_timestamps BEFORE INSERT OR UPDATE ON app_public.notifications FOR EACH ROW EXECUTE FUNCTION app_private.tg__timestamps();
...
--
-- Name: friend_requests _200_notification_on_friend_request; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _200_notification_on_friend_request AFTER INSERT OR UPDATE ON app_public.friend_requests FOR EACH ROW EXECUTE FUNCTION app_public.tg_notification_on_friend_request();


--
-- Name: mission_invites _200_notification_on_mission_invite; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _200_notification_on_mission_invite AFTER INSERT OR UPDATE ON app_public.mission_invites FOR EACH ROW EXECUTE FUNCTION app_public.tg_notification_on_mission_invite();
...
--
-- Name: mission_participants _200_update_count_on_participate_mission; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _200_update_count_on_participate_mission AFTER INSERT OR UPDATE ON app_public.mission_participants FOR EACH ROW EXECUTE FUNCTION app_public.tg_update_count_on_participant_mission();
...
--
-- Name: mission_participants _300_pupcles_on_complete_mission; Type: TRIGGER; Schema: app_public; Owner: -
--

CREATE TRIGGER _300_pupcles_on_complete_mission AFTER INSERT OR UPDATE ON app_public.mission_participants FOR EACH ROW EXECUTE FUNCTION app_public.tg_pupcles_on_complete_mission();
...
--
-- Name: mission_invites mission_invites_from_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_invites
    ADD CONSTRAINT mission_invites_from_user_id_fkey FOREIGN KEY (from_user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;


--
-- Name: mission_invites mission_invites_mission_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_invites
    ADD CONSTRAINT mission_invites_mission_id_fkey FOREIGN KEY (mission_id) REFERENCES app_public.missions(id) ON DELETE CASCADE;


--
-- Name: mission_invites mission_invites_to_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_invites
    ADD CONSTRAINT mission_invites_to_user_id_fkey FOREIGN KEY (to_user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;


--
-- Name: mission_participants mission_participants_mission_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_participants
    ADD CONSTRAINT mission_participants_mission_id_fkey FOREIGN KEY (mission_id) REFERENCES app_public.missions(id) ON DELETE CASCADE;


--
-- Name: mission_participants mission_participants_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.mission_participants
    ADD CONSTRAINT mission_participants_user_id_fkey FOREIGN KEY (user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;


--
-- Name: missions missions_period_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.missions
    ADD CONSTRAINT missions_period_fkey FOREIGN KEY (period) REFERENCES app_public.mission_period_kind(period);


--
-- Name: notifications notifications_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.notifications
    ADD CONSTRAINT notifications_user_id_fkey FOREIGN KEY (user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;
...
--
-- Name: missions delete_admin; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY delete_admin ON app_public.missions FOR DELETE USING ((EXISTS ( SELECT 1
   FROM app_public.users
...
--
-- Name: mission_invites delete_from_me; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: mission_invites delete_to_me; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: missions insert_admin; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY insert_admin ON app_public.missions FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM app_public.users
  WHERE ((users.is_admin IS TRUE) AND (users.id = app_public.current_user_id())))));
...
--
-- Name: mission_invites insert_from_me_to_friend; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY insert_from_me_to_friend ON app_public.mission_invites FOR INSERT WITH CHECK (((from_user_id = app_public.current_user_id()) AND (to_user_id IN ( SELECT app_public.current_user_shared_friend_ids() AS current_user_shared_friend_ids))));
...
--
-- Name: mission_invites; Type: ROW SECURITY; Schema: app_public; Owner: -
--

ALTER TABLE app_public.mission_invites ENABLE ROW LEVEL SECURITY;

--
-- Name: mission_participants; Type: ROW SECURITY; Schema: app_public; Owner: -
--

ALTER TABLE app_public.mission_participants ENABLE ROW LEVEL SECURITY;

--
-- Name: missions; Type: ROW SECURITY; Schema: app_public; Owner: -
--

ALTER TABLE app_public.missions ENABLE ROW LEVEL SECURITY;

--
-- Name: notifications; Type: ROW SECURITY; Schema: app_public; Owner: -
--
...
--
-- Name: missions select_all; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: mission_participants select_friends; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY select_friends ON app_public.mission_participants FOR SELECT USING ((user_id IN ( SELECT app_public.current_user_shared_friend_ids() AS current_user_shared_friend_ids)));
...
--
-- Name: mission_invites select_from_me; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: mission_participants select_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: notifications select_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: mission_invites select_to_me; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: missions update_admin; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY update_admin ON app_public.missions FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM app_public.users
  WHERE ((users.is_admin IS TRUE) AND (users.id = app_public.current_user_id())))));
...
--
-- Name: mission_invites update_to_me; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: FUNCTION tg_notification_on_friend_request(); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.tg_notification_on_friend_request() FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.tg_notification_on_friend_request() TO pupcle_visitor;


--
-- Name: FUNCTION tg_notification_on_mission_invite(); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.tg_notification_on_mission_invite() FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.tg_notification_on_mission_invite() TO pupcle_visitor;
...
--
-- Name: FUNCTION tg_pupcles_on_complete_mission(); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.tg_pupcles_on_complete_mission() FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.tg_pupcles_on_complete_mission() TO pupcle_visitor;


--
-- Name: FUNCTION tg_update_count_on_participant_mission(); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.tg_update_count_on_participant_mission() FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.tg_update_count_on_participant_mission() TO pupcle_visitor;
...
--
-- Name: TABLE mission_invites; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,DELETE ON TABLE app_public.mission_invites TO pupcle_visitor;


--
-- Name: COLUMN mission_invites.from_user_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(from_user_id) ON TABLE app_public.mission_invites TO pupcle_visitor;


--
-- Name: COLUMN mission_invites.to_user_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(to_user_id) ON TABLE app_public.mission_invites TO pupcle_visitor;


--
-- Name: COLUMN mission_invites.mission_id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(mission_id) ON TABLE app_public.mission_invites TO pupcle_visitor;


--
-- Name: COLUMN mission_invites.read; Type: ACL; Schema: app_public; Owner: -
--

GRANT UPDATE(read) ON TABLE app_public.mission_invites TO pupcle_visitor;


--
-- Name: TABLE mission_participants; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.mission_participants TO pupcle_visitor;


--
-- Name: TABLE mission_period_kind; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.mission_period_kind TO pupcle_authenticator;


--
-- Name: TABLE missions; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,DELETE ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.id; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(id),UPDATE(id) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.name; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(name),UPDATE(name) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.description; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(description),UPDATE(description) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.keywords; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(keywords),UPDATE(keywords) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.reward; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(reward),UPDATE(reward) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.period; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(period),UPDATE(period) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.day; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(day),UPDATE(day) ON TABLE app_public.missions TO pupcle_visitor;


--
-- Name: COLUMN missions.required_objects; Type: ACL; Schema: app_public; Owner: -
--

GRANT INSERT(required_objects),UPDATE(required_objects) ON TABLE app_public.missions TO pupcle_visitor;
...
GRANT SELECT ON TABLE app_public.notifications TO pupcle_visitor;
...
--
-- Name: COLUMN user_entries.phone; Type: ACL; Schema: app_public; Owner: -
--

GRANT UPDATE(phone) ON TABLE app_public.user_entries TO pupcle_visitor;
